...
describe('Command Option Validators', () => {
  ...
  describe('validateAgent', () => {
    it('should accept valid agents', () => {
      expect(validateAgent('claudeCode:claude-4-5-sonnet')).toBe('claudeCode:claude-4-5-sonnet');
    });
  ...
  describe('parseRepositories', () => {
    it('should parse comma-separated repository URLs', () => {
      const result = parseRepositories('https://github.com/org/repo1, https://github.com/org/repo2');
      expect(result).toEqual(['https://github.com/org/repo1', 'https://github.com/org/repo2']);
    });
    ...
    it('should reject invalid URLs', () => {
      ...
      expect(() => parseRepositories('https://valid.com, invalid')).toThrow(ValidationError);
    });
  });
